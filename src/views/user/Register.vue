    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="学校"
          v-decorator="['school', {rules: [{ required: true, message: '请输入学校名称' }], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="学号"
          v-decorator="['no', {rules: [{ required: true, message: '请输入学号' }], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      <a-form-item>
        <a-input
