      ...
      <result title="操作成功" :is-success="true" description="预计两小时内到账" style="max-width: 560px;">
        <div class="information">
          <a-row>
            ...
            <a-col :sm="16" :xs="24">jilinlilingzhi</a-col>
          </a-row>
          <a-row>
          ...
          <a-row>
            ...
            <a-col :sm="16" :xs="24">Alex</a-col>
          </a-row>
          <a-row>
            <a-col :sm="8" :xs="24">转账金额：</a-col>
            <a-col :sm="16" :xs="24"><span class="money">320</span> 元</a-col>
          </a-row>
        </div>
        <div slot="action">
          <!-- <a-button type="primary" @click="finish">查看</a-button> -->
